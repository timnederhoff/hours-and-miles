...
In order to be able to register hours spend on a customer and the miles/kilometers driven to a customer this project is setup.
...
To optimize the hoursandmiles application for production, run:
